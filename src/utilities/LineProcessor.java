...
public class LineProcessor {
    ...
    public static List<Integer> getNumbersFromInputString(String input, String regex) { // returns a list with numbers from a string
        List<Integer> integerList = new ArrayList<>();

        String[] parts = input.split(regex); // see day 6,7
